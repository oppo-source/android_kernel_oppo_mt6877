...
/*
 *  mt6877-afe-clk.c  --  Mediatek 6833 afe clock ctrl
 *
...
/* if clk not ready, dummy clk function */
int mt6877_init_clock(struct mtk_base_afe *afe) { return 0; }
int mt6877_afe_enable_clock(struct mtk_base_afe *afe) { return 0; }
void mt6877_afe_disable_clock(struct mtk_base_afe *afe) {}
int mt6877_afe_dram_request(struct device *dev) { return 0; }
int mt6877_afe_dram_release(struct device *dev) { return 0; }
int mt6877_apll1_enable(struct mtk_base_afe *afe) { return 0; }
void mt6877_apll1_disable(struct mtk_base_afe *afe) {}
int mt6877_apll2_enable(struct mtk_base_afe *afe) { return 0; }
void mt6877_apll2_disable(struct mtk_base_afe *afe) {}
int mt6877_get_apll_rate(struct mtk_base_afe *afe, int apll) { return 0; }
int mt6877_get_apll_by_rate(struct mtk_base_afe *afe, int rate) { return 0; }
int mt6877_get_apll_by_name(struct mtk_base_afe *afe, const char *name) { return 0; }
int mt6877_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate) { return 0; }
void mt6877_mck_disable(struct mtk_base_afe *afe, int mck_id) {}
int mt6877_set_audio_int_bus_parent(struct mtk_base_afe *afe, int clk_id) { return 0; }
#else
