...
//#define page_order android_kabi_reserved1   /* struct block_device */
#endif
...
extern bool transhuge_cont_pte_vma_suitable(struct vm_area_struct *vma,
						   unsigned long haddr);
...
extern bool within_cont_pte_cma(unsigned long pfn);
...
extern bool is_cont_pte_cma(struct cma *cma);
...
extern bool cont_pte_huge_page_enabled(void);
...
extern void count_vm_chp_event(enum vm_chp_event_item item);
extern void mod_chp_page_state(struct page *page, long delta);
...
extern bool is_thp_swap(struct swap_info_struct *si);

extern bool is_critical_native(struct task_struct *tsk);

extern bool current_is_hybridswapd(void);
...
#else
/* if device do not support hybridswap, disable wakeup kswapd */
static inline bool free_zram_is_ok(void) { return false; }
#endif
