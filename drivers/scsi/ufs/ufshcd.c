...
#endif /* CONFIG_OPLUS_FEATURE_UFS */
...
#if defined(CONFIG_OPLUS_FEATURE_UFS) && defined(CONFIG_UFSFEATURE)
...
#if defined(CONFIG_OPLUS_FEATURE_UFS) && defined(CONFIG_TRACEPOINTS)
			if (trace_ufshcd_command_enabled())
			{
