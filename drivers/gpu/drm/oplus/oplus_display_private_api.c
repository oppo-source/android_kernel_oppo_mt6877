...
int panel_serial_number_read(struct drm_crtc *crtc, char cmd, int num)
{
	...
	char read_sn_ili7838a_page[4] = {0xFF, 0x78, 0x38, 0x0F};
	char read_da_ili7838a_page[4] = {0xFF, 0x78, 0x38, 0x00};
	...
	if (!strcmp(panel_name, "ac138_p_3_a0004_cmd_panel")
		...
		|| !strcmp(panel_name, "ac168_p_3_a0004_cmd_panel")) {
                pr_info("ac138_p_3_a0004 | ac144_p_3_a0004 | ac168_p_3_a0004_cmd_panel set page0\n");
                ddic_dsi_send_cmd(4, read_sn_page);
        }
	if (!strcmp(panel_name, "ac168_p_B_a0012_cmd_panel")) {
			pr_info("ac168_p_B_a0012 set page0\n");
			ddic_dsi_send_cmd(4, read_sn_ili7838a_page);
		}
	while (count > 0) {
		...
		if ((!strcmp(panel_name, "oplus20181_samsung_ams643ye01_1080p_dsi_cmd,lcm"))
			...
			if (!strcmp(panel_name, "ac168_p_B_a0012_cmd_panel")) {
				pr_info("ac168_p_B_a0012 set page1\n");
				ddic_dsi_send_cmd(4, read_da_ili7838a_page);
			}
		} else {
			panel_serial_info.day       = para[panel_serial_info.reg_index + 1] & 0x1F;
	...
	if (!strcmp(panel_name, "ac138_p_3_a0004_cmd_panel")
		|| !strcmp(panel_name, "ac144_p_3_a0004_cmd_panel")
		|| !strcmp(panel_name, "ac168_p_3_a0004_cmd_panel")) {
                pr_info("ac138_p_3_a0004 | ac144_p_3_a0004 | ac168_p_3_a0004_cmd_panel set page1\n");
