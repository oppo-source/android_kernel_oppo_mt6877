...
//add for cabc
	...
	tianma_dcs_write_seq_static(ctx, 0x31, 0xF9);
	tianma_dcs_write_seq_static(ctx, 0x32, 0xF7);
	tianma_dcs_write_seq_static(ctx, 0x33, 0xF5);
	tianma_dcs_write_seq_static(ctx, 0x34, 0xF3);
	...
	tianma_dcs_write_seq_static(ctx, 0x38, 0xDD);
	tianma_dcs_write_seq_static(ctx, 0x39, 0xDA);
	tianma_dcs_write_seq_static(ctx, 0x3A, 0xD8);
	tianma_dcs_write_seq_static(ctx, 0x3B, 0xD6);
	tianma_dcs_write_seq_static(ctx, 0x3D, 0xD4);
	tianma_dcs_write_seq_static(ctx, 0x3F, 0xD2);
	tianma_dcs_write_seq_static(ctx, 0x40, 0xCF);
	tianma_dcs_write_seq_static(ctx, 0x41, 0xCC);
	tianma_dcs_write_seq_static(ctx, 0x45, 0xE5);
	tianma_dcs_write_seq_static(ctx, 0x46, 0xDE);
	tianma_dcs_write_seq_static(ctx, 0x47, 0xCF);
	tianma_dcs_write_seq_static(ctx, 0x48, 0xC7);
	tianma_dcs_write_seq_static(ctx, 0x49, 0xC1);
	tianma_dcs_write_seq_static(ctx, 0x4A, 0xBA);
	tianma_dcs_write_seq_static(ctx, 0x4B, 0xB8);
	tianma_dcs_write_seq_static(ctx, 0x4C, 0xB5);
	tianma_dcs_write_seq_static(ctx, 0x4D, 0xB0);
	tianma_dcs_write_seq_static(ctx, 0x4E, 0xAE);
	tianma_dcs_write_seq_static(ctx, 0x4F, 0xAB);
	tianma_dcs_write_seq_static(ctx, 0x50, 0xA8);
	tianma_dcs_write_seq_static(ctx, 0x51, 0xA6);
	tianma_dcs_write_seq_static(ctx, 0x52, 0xA3);
	tianma_dcs_write_seq_static(ctx, 0x53, 0xA0);
	tianma_dcs_write_seq_static(ctx, 0x54, 0x9B);
	tianma_dcs_write_seq_static(ctx, 0x58, 0xDF);
	tianma_dcs_write_seq_static(ctx, 0x59, 0xDA);
	tianma_dcs_write_seq_static(ctx, 0x5A, 0xCA);
	tianma_dcs_write_seq_static(ctx, 0x5B, 0xC2);
	tianma_dcs_write_seq_static(ctx, 0x5C, 0xB4);
	tianma_dcs_write_seq_static(ctx, 0x5D, 0xAB);
	tianma_dcs_write_seq_static(ctx, 0x5E, 0xA9);
	tianma_dcs_write_seq_static(ctx, 0x5F, 0xA8);
	tianma_dcs_write_seq_static(ctx, 0x60, 0xA7);
	tianma_dcs_write_seq_static(ctx, 0x61, 0xA6);
	tianma_dcs_write_seq_static(ctx, 0x62, 0xA0);
	tianma_dcs_write_seq_static(ctx, 0x63, 0x98);
	tianma_dcs_write_seq_static(ctx, 0x64, 0x90);
	tianma_dcs_write_seq_static(ctx, 0x65, 0x8A);
	tianma_dcs_write_seq_static(ctx, 0x66, 0x84);
	tianma_dcs_write_seq_static(ctx, 0x67, 0x77);
