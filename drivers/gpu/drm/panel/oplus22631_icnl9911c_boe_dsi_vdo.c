		...
		void *handle, unsigned int level)
{
	...
	if (level > 4095)
                level = 4095;
	if ((level > 12) && (level < oplus_max_normal_brightness)) {
		level = map_exp[level];
	}
		...
		void *handle, unsigned int cabc_mode)
{
	...
	char bl_tb6[] = {0xE1, 0xDE, 0xEE, 0xEF, 0xEE, 0xEE, 0xEE, 0xF0, 0x60, 0xD0, 0xD0, 0xD0, 0xD0, 0x35, 0xD0, 0xD0, 0xD0, 0xD0, 0xD0, 0xD0, 0xB2, 0x00, 0x04, 0x2A};
	char bl_tb7[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	char bl_tb8[] = {0xE1, 0x9D, 0xDD, 0xDC, 0xDD, 0xDD, 0xDD, 0xE0, 0xC6, 0x20, 0x7B, 0x20, 0x20, 0xA6, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0xA0, 0x00, 0x04, 0x2A};
	char bl_tb9[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xF4, 0xF4, 0xFE, 0xF4, 0xF4, 0xEF, 0xF4, 0xF4, 0xF4, 0xF4, 0xF4, 0xF4, 0xFF};
	char bl_tb10[] = {0xE1, 0x7C, 0xCC, 0xCB, 0xCC, 0xCC, 0xCC, 0xD0, 0x08, 0x22, 0xCC, 0x22, 0x22, 0xB0, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0xE0, 0x00, 0x04, 0x2A};
	char bl_tb11[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xE8, 0xE8, 0xFD, 0xE8, 0xE8, 0xE2, 0xE8, 0xE8, 0xE8, 0xE8, 0xE8, 0xE8, 0xFF};
	char bl_tb12[] = {0x53, 0x2C};
	pr_err("%s cabc = %d\n", __func__, cabc_mode);
