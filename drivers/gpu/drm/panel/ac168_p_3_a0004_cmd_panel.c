...
#include "../mediatek/mtk_corner_pattern/ac168_p_3_a0004_data_hw_roundpattern.h"
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "ac168_p_3_a0004_cmd_panel",
		.owner = THIS_MODULE,
...
MODULE_AUTHOR("oplus");
MODULE_DESCRIPTION("ac168,p_3,a0004,cmd,OLED Driver");
