...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x1B, 0x02);//120/240
	...
	lcm_dcs_write_seq_static(ctx, 0xE7, 0x4B);
	lcm_dcs_write_seq_static(ctx, 0xE8, 0x03);
