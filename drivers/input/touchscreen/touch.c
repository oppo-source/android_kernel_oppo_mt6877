...
bool  tp_judge_ic_match_commandline(struct panel_info *panel_data)
{
	...
	case 0x212A1:
		pr_info("[TP] case %d\n", prj_id);
		is_tp_type_got_in_match = true;
		pr_err("[TP] touch ic = focaltech3518,fts \n");
		tp_used_index = focal_ft3518;
		g_tp_dev_vendor = TP_SAMSUNG;
		break;
	default:
		       ...
		       struct panel_info *panel_data)
{
	...
	if (prj_id == 21851 || prj_id == 0x212A1 || prj_id == 21876) {
	...
	if (strstr(saved_command_line, "oplus20171_tianma_nt37701")) {
		hw_res->TX_NUM = 18;
		hw_res->RX_NUM = 40;
		vendor = "TIANMA";
	}
	...
	case 20615:
	case 20662:
		pr_info("[TP] enter case OPLUS_20615\n");
