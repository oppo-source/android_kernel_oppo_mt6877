...
bool __init tp_judge_ic_match(char *tp_ic_name)
{
	...
	case 23035:
	case 23321:
		pr_info("[TP] tp judge ic forward for 23035\n");
		if (strstr(tp_ic_name, "focaltech-FT3681") && strstr(saved_command_line, "ac168_p_B_a0012_cmd_panel")) {
			return true;
		}
		if (strstr(tp_ic_name, "focaltech-FT3681") && strstr(saved_command_line, "ac168_p_3_a0004_cmd_panel")) {
			return true;
		}
		return false;
	case 23051:
	...
	case 23243:
		pr_info("[TP] tp judge ic forward for %d\n", prj_id);
		/* temporary add to test the touchpanel. Need to delete this later - oplus20181_samsung_ams643ye01_1080p_dsi_cmd */
		if (strstr(tp_ic_name, "focaltech-FT3681") && strstr(saved_command_line, "oplus20181_samsung_ams643ye01_1080p_dsi_cmd")) {
			return true;
		}
		if (strstr(tp_ic_name, "focaltech-FT3681") && strstr(saved_command_line, "ac144_p_3_a0004_cmd_panel")) {
			return true;
		}
		if (strstr(tp_ic_name, "synaptics-s3910") && strstr(saved_command_line, "ac144_p_7_a0012_cmd_panel")) {
			return true;
		}
		return false;
	...
	case 23687:
	case 23689:
		pr_info("[TP] tp judge ic forward for 23613 23686 23687 23689\n");
	...
	case 23703:
	case 23704:
		pr_info("[TP] tp judge ic for ark 23618\n");
		if (strstr(tp_ic_name, "ilitek,ili7807s") && strstr(saved_command_line, "oplus23703_ili9883c_hkc_hdp_dsi_vdo")) {
			return true;
		}
		if (strstr(tp_ic_name, "ilitek,ili7807s") && strstr(saved_command_line, "oplus23703_ili9883c_dj_hdp_dsi_vdo")) {
			return true;
		}
		if (strstr(tp_ic_name, "focaltech,fts") && strstr(saved_command_line, "oplus23703_ft8057p_xx_hdp_dsi_vdo")) {
			return true;
		}
		pr_err("[TP] ERROR! ic is not match driver\n");
		return false;
...
bool  tp_judge_ic_match_commandline(struct panel_info *panel_data)
{
	...
	case 22277:
		...
		break;
	case 23031:
		pr_info("[TP] case 23031\n");
		is_tp_type_got_in_match = true;
		if (strstr(saved_command_line, "oplus23031_vxn_ili7838a_fhd_dsi_cmd_lcm")) {
			tp_used_index = focal_ft3681;
			g_tp_dev_vendor = TP_VXN;
		}
		break;
	case 23035:
	case 23321:
		pr_info("[TP] case 23035\n");
		is_tp_type_got_in_match = true;
		if (strstr(saved_command_line, "ac168_p_B_a0012_cmd_panel")) {
			tp_used_index = focal_ft3681;
			g_tp_dev_vendor = TP_VXN;
		}
		if (strstr(saved_command_line, "ac168_p_3_a0004_cmd_panel")) {
			tp_used_index = focal_ft3681;
			g_tp_dev_vendor = TP_BOE;
		}
		break;
	/* bringup add for Magellan touchscreen.*/
	case 23051:
	case 23241:
	case 23243:
		pr_info("[TP] case %d\n", prj_id);
		is_tp_type_got_in_match = true;
		/* temporary add to test the touchpanel. Need to delete this later - oplus20181_samsung_ams643ye01_1080p_dsi_cmd */
		if (strstr(saved_command_line, "oplus20181_samsung_ams643ye01_1080p_dsi_cmd")) {
			tp_used_index = focal_ft3681;
			g_tp_dev_vendor = TP_VXN;
		}
		if (strstr(saved_command_line, "ac144_p_3_a0004_cmd_panel")) {
			tp_used_index = focal_ft3681;
			g_tp_dev_vendor = TP_BOE;
		}
		if (strstr(saved_command_line, "ac144_p_7_a0012_cmd_panel")) {
			tp_used_index = synaptics_s3910;
			g_tp_dev_vendor = TP_TIANMA;
		}
		break;
	case 23231:
	...
	case 23055:
	case 23253:
		pr_info("[TP] case 23053 23054 23055 23253 Lijing-A\n");
		is_tp_type_got_in_match = true;
	...
	case 23687:
	case 23689:
		pr_info("[TP] case 23613 23686 23687 23689\n");
		is_tp_type_got_in_match = true;
	...
	case 23704:
		...
		if (strstr(saved_command_line, "oplus23703_ili9883c_hkc_hdp_dsi_vdo")) {
			pr_info("[TP] touch ic = ili9883c_hkc \n");
			tp_used_index = ili9883c_hkc;
			g_tp_dev_vendor = TP_HKC;
		}
		if (strstr(saved_command_line, "oplus23703_ili9883c_dj_hdp_dsi_vdo")) {
			pr_info("[TP] touch ic = ili9883c_djn \n");
			tp_used_index = ili9883c_djn;
			g_tp_dev_vendor = TP_DJN;
		}
		if (strstr(saved_command_line, "oplus23703_ft8057p_xx_hdp_dsi_vdo")) {
			pr_info("[TP] touch ic = ft8057p_xx \n");
			tp_used_index = ft8057p_xx;
			g_tp_dev_vendor = TP_XX;
		}
		break;
	default:
...
|| prj_id == 20108 || prj_id == 20109 || prj_id == 20307) {
	...
	if (prj_id == 23031) {
		pr_info("[TP] tp_util_get_vendor 23031 chanel vendor\n");
		if (strstr(saved_command_line, "oplus23031_vxn_ili7838a_fhd_dsi_cmd_lcm")) {
			vendor = "VXN";
		}
	}
	if (prj_id == 23035 || prj_id == 23321) {
		pr_info("[TP] tp_util_get_vendor 23035 chanel vendor\n");
		if (strstr(saved_command_line, "ac168_p_B_a0012_cmd_panel")) {
			vendor = "VXN";
		}
		if (strstr(saved_command_line, "ac168_p_3_a0004_cmd_panel")) {
	...
	if (prj_id == 23051 || prj_id == 23241 || prj_id == 23243) {
		pr_info("[TP] tp_util_get_vendor 23051 magellan vendor\n");
		if (strstr(saved_command_line, "oplus20181_samsung_ams643ye01_1080p_dsi_cmd")) {
			vendor = "VXN";
		}
		if (strstr(saved_command_line, "ac144_p_3_a0004_cmd_panel")) {
	...
	if (prj_id == 23613 || prj_id == 23686 || prj_id == 23687 || prj_id == 23689) {
		pr_info("[TP] tp_util_get_vendor 23163 23636 23687 rename vendor\n");
		if (strstr(saved_command_line, "oplus23687_samsung_ams667fk02_s6e8fc3_fhdp_dsi_vdo")) {
			vendor = "SAMSUNG";
		}
	}
...
*/
	...
	case 22277:
		...
		break;
	case 23031:
		pr_info("[TP] enter case 23031\n");
		if (tp_used_index == focal_ft3681) {
			if (g_tp_dev_vendor == TP_VXN) {
				pr_info("[TP] 23031 tp vendor VXN\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/23031/FW_%s_%s.img",
					"FT3681", vendor);
				if (panel_data->test_limit_name) {
				snprintf(panel_data->test_limit_name, MAX_LIMIT_DATA_LENGTH,
					"tp/23031/LIMIT_%s_%s.img",
					"FT3681", vendor);
				}

				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAC118VXN01", 12);
				panel_data->firmware_headfile.firmware_data = FW_22612_FT3681_TIANMA;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_22612_FT3681_TIANMA);
			}
		}
	...
	case 23035:
	case 23321:
		pr_info("[TP] enter case 23035\n");
		if (tp_used_index == focal_ft3681) {
			if (g_tp_dev_vendor == TP_VXN) {
				pr_info("[TP] 23035 tp vendor VXN\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/23035/FW_%s_%s.img",
					"FT3681", vendor);
				if (panel_data->test_limit_name) {
				snprintf(panel_data->test_limit_name, MAX_LIMIT_DATA_LENGTH,
					"tp/23035/LIMIT_%s_%s.img",
					"FT3681", vendor);
				}

				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAC168VXN01", 12);
				panel_data->firmware_headfile.firmware_data = FW_22612_FT3681_TIANMA;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_22612_FT3681_TIANMA);
			}
		}
		if (tp_used_index == focal_ft3681) {
			if (g_tp_dev_vendor == TP_BOE) {
				pr_info("[TP] 23035 tp vendor BOE\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/23035/FW_%s_%s.img",
					"FT3681", "BOE");
				if (panel_data->test_limit_name) {
				...
				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAC168001", 10);
				panel_data->firmware_headfile.firmware_data = FW_22612_FT3681_TIANMA;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_22612_FT3681_TIANMA);
			}
		}
	...
	case 23241:
	case 23243:
		pr_info("[TP] enter case 23051/23241\n");
		if (tp_used_index == focal_ft3681) {
			if (g_tp_dev_vendor == TP_BOE) {
				pr_info("[TP] 23051/23241 tp vendor VXN\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/23051/FW_%s_%s.img",
					"FT3681", vendor);
				if (panel_data->test_limit_name) {
				snprintf(panel_data->test_limit_name, MAX_LIMIT_DATA_LENGTH,
					"tp/23051/LIMIT_%s_%s.img",
					"FT3681", vendor);
				}
				vendor = "FT3681_BOE";
				strcpy(panel_data->manufacture_info.manufacture, vendor);
				...
				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAC143BOE01", 12);
				panel_data->firmware_headfile.firmware_data = FW_22612_FT3681_TIANMA;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_22612_FT3681_TIANMA);
			}
		}
		if (tp_used_index == synaptics_s3910) {
			if (g_tp_dev_vendor == TP_TIANMA) {
				pr_info("[TP] 23051/23241 tp vendor VXN\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/23051/FW_%s_%s.img",
				...
				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAC143TM001", 12);
				panel_data->firmware_headfile.firmware_data = FW_22612_FT3681_TIANMA;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_22612_FT3681_TIANMA);
			}
		}
	...
	case 23687:
	case 23689:
		pr_info("[TP] enter case 23613 23686 23687 23689\n");
		if (tp_used_index == focal_ft3658u) {
			if (g_tp_dev_vendor == TP_SAMSUNG) {
				pr_info("[TP] 23613 23686 23687 23689 tp vendor samsung\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
	...
	case 0x216CA:
		...
		panel_data->manufacture_info.fw_path = panel_data->fw_name;
		break;
	/*BSP.TP.Function, 2023/12/11, add tp path for ARK.*/
	case 23618:
	case 23702:
	case 23703:
	case 23704:
		pr_info("[TP] enter case 23618,23702,23703,23704\n");
		if (tp_used_index == ili9883c_hkc) {
			if (g_tp_dev_vendor == TP_HKC) {
				pr_info("[TP] 23618,23702,23703,23704 tp vendor hkc\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/%d/FW_%s_%s.img",
					prj_id, "ILI9883C", "HKC");
				if (panel_data->test_limit_name) {
				snprintf(panel_data->test_limit_name, MAX_LIMIT_DATA_LENGTH,
					"tp/%d/LIMIT_%s_%s.ini",
					prj_id, "ILI9883C", "HKC");
				}
				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAB623001", 10);
				panel_data->firmware_headfile.firmware_data = FW_23703_ILI9883C_HKC;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_23703_ILI9883C_HKC);
			}
		}
		if (tp_used_index == ili9883c_djn) {
			if (g_tp_dev_vendor == TP_DJN) {
				pr_info("[TP] 23618,23702,23703,23704 tp vendor djn\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/%d/FW_%s_%s.img",
					prj_id, "ILI9883C", "DJN");
				if (panel_data->test_limit_name) {
				...
				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAB623001", 10);
				panel_data->firmware_headfile.firmware_data = FW_23703_ILI9883C_DJN;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_23703_ILI9883C_DJN);
			}
		}
		if (tp_used_index == ft8057p_xx) {
			if (g_tp_dev_vendor == TP_XX) {
				pr_info("[TP] 23618,23702,23703,23704 tp vendor XX\n");
				snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
					"tp/%d/FW_%s_%s.img",
					prj_id, "FT8057P", "XX");
				if (panel_data->test_limit_name) {
				...
				panel_data->manufacture_info.fw_path = panel_data->fw_name;
				memcpy(panel_data->manufacture_info.version, "0xAB623001", 10);
				panel_data->firmware_headfile.firmware_data = FW_23703_FT8057P_XX;
				panel_data->firmware_headfile.firmware_size = sizeof(FW_23703_FT8057P_XX);
			}
		}
		break;
	default:
