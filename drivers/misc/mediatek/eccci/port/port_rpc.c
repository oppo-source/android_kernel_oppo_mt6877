...
static int get_md_gpio_val(unsigned int num)
{
    ...
    if(is_project(20375) || is_project(20376) || is_project(20377) || is_project(20378) || is_project(20379) || is_project(0x2037A)
        ...
        || is_project(22301) || is_project(22302) || is_project(22303) || is_project(22304) || is_project(22309) || is_project(23618) || is_project(23702) || is_project(23703) || is_project(23704))
    {
