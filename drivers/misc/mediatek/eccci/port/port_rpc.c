...
static int get_md_gpio_val(unsigned int num)
{
    ...
    if(is_project(20375) || is_project(20376) || is_project(20377) || is_project(20378) || is_project(20379) || is_project(0x2037A)
        ...
        || is_project(22603) || is_project(22604) || is_project(22609) || is_project(22669) || is_project(0x2266A) || is_project(0x2266B) || is_project(0x2266C) || is_project(0x2260A) || is_project(0x2260B)|| is_project(22631)|| is_project(22632)
