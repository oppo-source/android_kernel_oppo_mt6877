...
/*
 * DW9827AF_23231_IMX882PD voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9827AF_23231_IMX882PD_DRV"
...
static inline int moveAF(unsigned long a_u4Position)
{
    ...
    int a_u4_NewPosition = a_u4Position * 16;
...
/* ////////////////////////////////////////////////////////////// */
long DW9827AF_23231_IMX882PD_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9827AF_23231_IMX882PD_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int DW9827AF_23231_IMX882PD_PowerDown(struct i2c_client *pstAF_I2Cclient,
            int *pAF_Opened)
{
...
int DW9827AF_23231_IMX882PD_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9827AF_23231_IMX882PD_GetFileName(unsigned char *pFileName)
{
...
#endif
int DW9827AF_23231_IMX882PD_DoExtLdo(int enable)
{
    LOG_INF("DW9827AF_23231_IMX882PD_DoExtLdo enable: %d", enable);
#if !defined(CONFIG_MACH_MT6765)
    if(enable) {
