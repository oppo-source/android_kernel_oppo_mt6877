...
#define AF_DRVNAME "AK7316AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long AK7316AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int AK7316AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int AK7316AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
            int *pAF_Opened)
{
...
int AK7316AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int AK7316AF_GetFileName(unsigned char *pFileName)
{
...
#endif
int AK7316AF_DoExtLdo(int enable)
{
    LOG_INF("AK7316AF_DoExtLdo enable: %d", enable);
#if !defined(CONFIG_MACH_MT6765)
    if(enable) {
