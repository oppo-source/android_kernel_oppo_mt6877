...
/*
 * DW9800SAFPD voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9800SAFPD_DRV"
...
#if 0
static int s4DW9800SAFPD_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long DW9800SAFPD_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800SAFPD_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9800SAFPD_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9800SAFPD_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800SAFPD_GetFileName(unsigned char *pFileName)
{
