...
/*
 * FP5513E4AF_S5KJN103 voice coil motor driver
 *
 *
 */
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	LOG_INF("s4AF_WriteReg : i4RetValue = %d\n",i4RetValue);
	if (i4RetValue < 0) {
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("fp5513 moveAF ret = %d,a_u4Position = %d\n",ret,a_u4Position);
...
/* ////////////////////////////////////////////////////////////// */
long FP5513AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int FP5513AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
int FP5513AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int FP5513AF_GetFileName(unsigned char *pFileName)
{
