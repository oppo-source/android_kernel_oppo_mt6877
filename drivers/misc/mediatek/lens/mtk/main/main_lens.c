...
void AFRegulatorCtrl(int Stage)
{
	...
	if(is_project(22087) || is_project(22088) || is_project(22331) || is_project(22332) || is_project(22333) || is_project(22334)) {
            return;
    }
    ...
    if(is_project(22351) || is_project(22352) || is_project(22353) || is_project(22361) || is_project(22362) || is_project(22363)
        ||is_project(22364) || is_project(22365) || is_project(22366) || is_project(22367)) {
			...
			if (node) {
				...
				lens_device->of_node = kd_node;
                            ...
                            if (is_project(0x2169E) || is_project(0x2169F) || is_project(0x216C9) || is_project(0x216CA)) {
                                ...
                                //regVCAMAF = regulator_get(lens_device, "vtp");
                            } else if (is_project(22087) || is_project(22088) || is_project(22331) || is_project(22332) || is_project(22333) || is_project(22334)) {
