...
void AFRegulatorCtrl(int Stage)
{
    ...
    if (is_project(0x2167A) || is_project(0x2167B) || is_project(0x2167C) || is_project(0x2167D) || is_project(0x226AD) || is_project(0x226AE) || is_project(0x226AF) || is_project(0x226B0)) {
        Other_AFRegulatorCtrl(Stage);
        return;
    }
			...
			if (node) {
				...
				lens_device->of_node = kd_node;
                            ...
                            if (is_project(0x2169E) || is_project(0x2169F) || is_project(0x216C9) || is_project(0x216CA)) {
                                ...
                                regVCAMAF = regulator_get(lens_device, "vldo28"); 
                            }else if (is_project(0x226AD) || is_project(0x226AE) || is_project(0x226AF) || is_project(0x226B0)) {
