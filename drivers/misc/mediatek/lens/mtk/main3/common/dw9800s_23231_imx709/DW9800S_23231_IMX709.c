...
#define AF_DRVNAME "DW9800S_IMX709_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		/* soft power on */
        /* DW9800S_23231_IMX709 VCM Driver init*/
        char puSendCmd2[2] = {0x06, 0x40};
        char puSendCmd3[2] = {0x07, 0x6C};
...
/* ////////////////////////////////////////////////////////////// */
long DW9800S_23231_IMX709_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800S_23231_IMX709_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9800S_23231_IMX709_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9800S_23231_IMX709_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800S_23231_IMX709_GetFileName(unsigned char *pFileName)
{
