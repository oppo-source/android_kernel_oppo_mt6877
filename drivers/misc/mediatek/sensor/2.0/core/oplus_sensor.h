...
/* end sensor type */
#define SENSOR_TYPE_FACE_DOWN_DETECT                   (OPLUS_VIRTAUL_SENSOR_START + 12)
#define VIRTUAL_SENSOR_TYPE_MAX                         (SENSOR_TYPE_FACE_DOWN_DETECT +1)
...
/* end sensor ID */
#define ID_FACE_DOWN_DETECT     (ID_OPLUS_BASE + SENSOR_TYPE_FACE_DOWN_DETECT - 1)

#define ID_VIRTUAL_SENSOR_MAX    (ID_FACE_DOWN_DETECT + 1)
...
union oplus_data_unit_t {
	...
	face_down_detect_event_t face_down_detect_data_t;
