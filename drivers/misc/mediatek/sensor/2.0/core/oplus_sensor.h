...
#define SENSOR_TYPE_PHONE_PROX                        (OPLUS_VIRTAUL_SENSOR_START + 15)
#define SENSOR_TYPE_GESTURE_PROX                        (OPLUS_VIRTAUL_SENSOR_START + 16)
#define SENSOR_TYPE_AMBIENTE_PROX                        (OPLUS_VIRTAUL_SENSOR_START + 17)
