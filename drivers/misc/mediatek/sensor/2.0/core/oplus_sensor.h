...
#define SENSOR_TYPE_PALM_DETECT                        (OPLUS_VIRTAUL_SENSOR_START + 15)
//#endif //OPLUS_FEATURE_PALM_DETECT

#define SENSOR_TYPE_PHONE_PROX                        (OPLUS_VIRTAUL_SENSOR_START + 16)
#define SENSOR_TYPE_GESTURE_PROX                        (OPLUS_VIRTAUL_SENSOR_START + 17)
#define SENSOR_TYPE_AMBIENTE_PROX                        (OPLUS_VIRTAUL_SENSOR_START + 18)

/* end sensor type */
#define VIRTUAL_SENSOR_TYPE_MAX                         (SENSOR_TYPE_AMBIENTE_PROX +1)
...
//#ifdef OPLUS_FEATURE_PALM_DETECT
#define ID_PALM_DETECT      (ID_OPLUS_BASE + SENSOR_TYPE_PALM_DETECT - 1)
//#endif //OPLUS_FEATURE_LAY_DETECT
#define ID_PHONE_PROX      (ID_OPLUS_BASE + SENSOR_TYPE_PHONE_PROX - 1)
#define ID_GESTURE_PROX      (ID_OPLUS_BASE + SENSOR_TYPE_GESTURE_PROX - 1)
#define ID_AMBIENTE_PROX      (ID_OPLUS_BASE + SENSOR_TYPE_AMBIENTE_PROX - 1)

/* end sensor ID */
#define ID_VIRTUAL_SENSOR_MAX    (ID_AMBIENTE_PROX + 1)
typedef struct {
    uint32_t value;
