...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.lcm_esd_check_table[0].cmd = 0xAB;
	...
	register_device_proc("lcd", "nt36672c", "tianma");
}
...
static void lcm_init(void)
{
	...
	pr_err("nt36672c_tm_lcm_mode = vdo mode :%d\n", lcm_dsi_mode);
}
...
struct LCM_DRIVER oplus22351_tm_nt36672c_fhd_dsi_vdo_lcm_drv = {
	.name = "oplus22351_tm_nt36672c_fhd_dsi_vdo_lcm_drv",
