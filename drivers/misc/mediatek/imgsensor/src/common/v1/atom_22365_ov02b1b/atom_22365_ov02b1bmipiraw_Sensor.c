...
#include "atom_22365_ov02b1bmipiraw_Sensor.h"
...
#define PFX "atom_22365_ov02b1b_camera_sensor"
...
static  struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = ATOM_22365_OV02B1B_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			write_cmos_sensor(0xfd, 0x00);
			*sensor_id = ((read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03)+0x11);
			LOG_INF("[atom_22365_ov02b1b] get_imgsensor_id:0x%x  i2c:0x%x\n", *sensor_id, imgsensor.i2c_write_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("[atom_22365_ov02b1b] i2c write id: 0x%x, sensor id: 0x%x, imgsensor_info.sensor_id: 0x%x\n",
