...
static imgsensor_info_struct imgsensor_info = {
    ...
    .i2c_addr_table = {0x7a, 0x7b, 0x78,0xff},
    .i2c_speed = 400,
};
...
static void read_module_data(void)
{
    ...
    gImgEepromInfo_20181.camNormdata[3][0] = Eeprom_1ByteDataRead(0x00, 0xA4);
    gImgEepromInfo_20181.camNormdata[3][1] = Eeprom_1ByteDataRead(0x01, 0xA4);
    gImgEepromInfo_20181.camNormdata[3][48] = 0xFF;
    gImgEepromInfo_20181.camNormdata[3][49] = 0xFF;
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, 0xA4);
    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_20181.pCamModuleInfo[3].name,
                                    gImgEepromInfo_20181.pCamModuleInfo[3].version,
                                    imgsensor_info.module_id);
    for(i = 2; i < 8; i++) {
       gImgEepromInfo_20181.camNormdata[3][i] = Eeprom_1ByteDataRead(0x04+i, 0xA4);
       gImgEepromInfo_20181.camNormdata[3][i+48] = 0xFF;
    }

    for (i = 0; i < OPPO_CAMERASN_LENS; i ++) {
       gImgEepromInfo_20181.camNormdata[3][8+i] = Eeprom_1ByteDataRead(0xB0+i, 0xA4);
    }
    vcmID = Eeprom_1ByteDataRead(0x7, 0xA4);
    lensID = Eeprom_1ByteDataRead(0x6, 0xA4);
    memcpy(&gImgEepromInfo_20181.camNormdata[3][40], &vcmID, 4);
    memcpy(&gImgEepromInfo_20181.camNormdata[4][44], &lensID, 4);
    gImgEepromInfo_20181.i4CurSensorIdx = 3;
    gImgEepromInfo_20181.i4CurSensorId = imgsensor_info.sensor_id;
}
