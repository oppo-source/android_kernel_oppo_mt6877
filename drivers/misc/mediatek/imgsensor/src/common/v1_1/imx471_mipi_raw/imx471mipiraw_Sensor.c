...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .custom1 = { /* reg_B-14-3 15fps sensor mode5 for smile.gifmaker apk*/
        .pclk = 288000000,
        .linelength = 2560,
        .framelength = 7500,
        .startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[11] = {
	...
	{4656, 3496, 24,  444, 4608, 2608, 2304, 1304,   0,   4, 2304, 1296, 0, 0, 2304, 1296},  /* custom1 */
...
static void Read_Eeprom_Data(void)
{
    ...
    gImgEepromInfo_21081.camNormdata[1][0] = Eeprom_1ByteDataRead(0x00, 0xA8);
    gImgEepromInfo_21081.camNormdata[1][1] = Eeprom_1ByteDataRead(0x01, 0xA8);
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, 0xA8);
    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_21081.pCamModuleInfo[1].name,
                                    gImgEepromInfo_21081.pCamModuleInfo[1].version,
                                    imgsensor_info.module_id);
    for(i = 2; i < 8; i++) {
        gImgEepromInfo_21081.camNormdata[1][i] = Eeprom_1ByteDataRead(0x04+i, 0xA8);
    }
    for (i = 0; i < OPPO_CAMERASN_LENS; i ++) {
        gImgEepromInfo_21081.camNormdata[1][8+i] = Eeprom_1ByteDataRead(0xB0+i, 0xA8);
    }
    gImgEepromInfo_21081.i4CurSensorIdx = 1;
    gImgEepromInfo_21081.i4CurSensorId = imgsensor_info.sensor_id;
}
