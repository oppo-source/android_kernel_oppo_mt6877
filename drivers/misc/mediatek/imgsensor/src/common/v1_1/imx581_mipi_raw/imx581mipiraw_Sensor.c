...
static void Read_Eeprom_Data(void)
{
    ...
    gImgEepromInfo_21081.camNormdata[0][0] = Eeprom_1ByteDataRead(0x00, 0xA0);
    gImgEepromInfo_21081.camNormdata[0][1] = Eeprom_1ByteDataRead(0x01, 0xA0);
    ...
    for(i = 2; i < 8; i++) {
        gImgEepromInfo_21081.camNormdata[0][i] = Eeprom_1ByteDataRead(0x04+i, 0xA0);
    }
    for (i = 0; i < OPPO_CAMERASN_LENS; i ++) {
        gImgEepromInfo_21081.camNormdata[0][8+i] = Eeprom_1ByteDataRead(0xB0+i, 0xA0);
    }
    gImgEepromInfo_21081.i4CurSensorIdx = 0;
