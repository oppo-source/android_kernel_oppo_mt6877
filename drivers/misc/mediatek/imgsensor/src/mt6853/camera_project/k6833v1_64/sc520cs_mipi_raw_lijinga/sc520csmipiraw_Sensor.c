...
#define PFX "sc520cs_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC520CS_SENSOR_ID_LIJINGA,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
 ...
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1460, 0000, 0000, 2592, 1460,    0,	0, 2592, 1460}, // video
...
/*  hs04 code for SR-AL6398A-01-12 by liluling at 2022/8/3 end */
	...
	write_cmos_sensor8(0x3e09, SC520CS_AGC_Param[gain_index][1]);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_sc520cs[] = {
0x0100,0x00,
0x3220,0x80,
0x3200,0x00,
0x3201,0x00,
...
#if MULTI_WRITE
	sc520cs_table_write_cmos_sensor(
		addr_data_pair_video_sc520cs,
		sizeof(addr_data_pair_video_sc520cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor8(0x0100,0x00);
    write_cmos_sensor8(0x3220,0x80);
