...
#include "gc02m1mipiraw23687_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID23687,
...
kal_uint16 addr_data_pair_init_gc02m1_tacoo[] = {
	/*system*/
	0xfc, 0x01,
	0xf4, 0x41,
...
kal_uint16 addr_data_pair_preview_gc02m1_tacoo[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_capture_gc02m1_tacoo[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_tacoo[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_tacoo[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_tacoo[] = {
	0xfe, 0x00,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1_tacoo,
		sizeof(addr_data_pair_init_gc02m1_tacoo) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1_tacoo,
		sizeof(addr_data_pair_preview_gc02m1_tacoo) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1_tacoo,
		sizeof(addr_data_pair_capture_gc02m1_tacoo) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1_tacoo,
		sizeof(addr_data_pair_normal_video_gc02m1_tacoo) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1_tacoo,
		sizeof(addr_data_pair_hs_video_gc02m1_tacoo) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1_tacoo,
		sizeof(addr_data_pair_slim_video_gc02m1_tacoo) /
		sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	printk("gc02m get_imgsensor_id----1  0x%x\n",imgsensor_info.sensor_id);
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = (return_sensor_id());
			printk("gc02m get_imgsensor_id----2  0x%x\n",*sensor_id);
			if (*sensor_id == GC02M1_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				if (deviceInfo_register_value == 0x00) {
					...
					Eeprom_DataInit(3, GC02M1_SENSOR_ID23687);
