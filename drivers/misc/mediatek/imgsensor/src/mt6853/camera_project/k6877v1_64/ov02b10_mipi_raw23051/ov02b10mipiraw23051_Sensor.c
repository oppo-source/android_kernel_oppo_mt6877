...
#include "ov02b10mipiraw23051_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV02B10_SENSOR_ID23051,
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == OV02B10_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("Ov02b10 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                if (deviceInfo_register_value == 0x00) {
                    Eeprom_DataInit(IMGSENSOR_SENSOR_IDX_SUB2, OV02B10_SENSOR_ID23051);
            ...
            pr_info("Ov02b10 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
        retry = 2;
