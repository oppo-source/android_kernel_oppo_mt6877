...
#include "ov64bmipiraw23051_Sensor.h"
#include "ov64b_Sensor23051_setting.h"
...
#define PFX "OV64B_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV64B_SENSOR_ID23051,
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == OV64B_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("Ov64b Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                read_EepromQSC();
                if (deviceInfo_register_value == 0x00) {
                    Eeprom_DataInit(IMGSENSOR_SENSOR_IDX_MAIN, OV64B_SENSOR_ID23051);
            ...
            pr_info("Ov64b Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
        retry = 2;
            ...
            UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    *(feature_data + 1) = imgsensor_info.min_shutter;
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = -2429791;
        break;
