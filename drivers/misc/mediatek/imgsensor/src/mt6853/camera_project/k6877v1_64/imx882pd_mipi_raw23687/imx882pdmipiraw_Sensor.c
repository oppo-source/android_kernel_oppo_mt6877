...
#define PFX "imx882pd_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX882PD_SENSOR_ID23687,
    ...
    .normal_video = { //reg_B2  4096x2304 @30FPS QBIN(VBIN) w/ Partial-PD VB Max
        .pclk = 878400000,
        .linelength = 4616,
        .framelength = 6299,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 1028736000,//1504.00 Msps/Trio *3*2.28/10 = 699.048
        .max_framerate = 300,
    },
    ...
    .custom2 = { //reg_B3 4096x2304 @60FPS QBIN(VBIN) w/ Partial-PD VB Max
        .pclk = 878400000,
        .linelength = 4616,
        .framelength = 3149,
        .startx = 0,
        ...
        .grabwindow_height = 2304,
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 1028736000,  //1504.00 Msps/Trio *3*2.28/10
        .max_framerate = 600,
    },
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    write_cmos_sensor_8(0x3228, 0x02);
    write_cmos_sensor_8(0x0104, 0x01);
    write_cmos_sensor_8(0x322A, 0x00);
    write_cmos_sensor_8(0x322B, 0x00);
    write_cmos_sensor_8(0x322C, 0x00);
    write_cmos_sensor_8(0x322D, 0x00);
    write_cmos_sensor_8(0x322E, 0x00);
    write_cmos_sensor_8(0x322F, 0x00);
    write_cmos_sensor_8(0x0104, 0x00);
    LOG_INF("%s end\n", __func__);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
     ...
     */
    LOG_INF("imx882pd Enter %s.", __func__);
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
            ...
            if (*sensor_id == IMX882PD_SENSOR_ID23687) {
                *sensor_id = imgsensor_info.sensor_id;
                LOG_INF("Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                if(first_read){
                    read_imx882pd_23687_SPC(imx882_SPC_setting);
                    read_imx882pd_23687_QSC(imx882_QSC_setting);
                    first_read = KAL_FALSE;
                }
                if(deviceInfo_register_value == 0x00){
                    Eeprom_DataInit(0, IMX882PD_SENSOR_ID23687);
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882pd_23687_seamless_preview, sizeof(imx882pd_23687_seamless_preview) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882pd_23687_seamless_custom5, sizeof(imx882pd_23687_seamless_custom5) / sizeof(kal_uint16));
        if (ae_ctrl) {
