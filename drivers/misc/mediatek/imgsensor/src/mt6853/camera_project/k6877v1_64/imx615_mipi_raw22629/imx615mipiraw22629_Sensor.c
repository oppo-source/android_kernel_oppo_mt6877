...
#include "imx615mipiraw22629_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX615_SENSOR_ID22629,
    .checksum_value = 0x8ac2d94a,

    .pre = { /* reg_B-1 3264x2448 @30fps*/
        .pclk = 597600000,
        .linelength = 3768,
        .framelength = 2642,
        .startx = 0,
            ...
            if (*sensor_id == 0x0615) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(deviceInfo_register_value == 0x00){
                        Eeprom_DataInit(1, IMX615_SENSOR_ID22629);
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = -1043771;
        LOG_INF("exporsure");
    break;
