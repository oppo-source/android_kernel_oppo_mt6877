...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[12] = {
    ...
    { 11584, 8688,    0,    0,  5792, 4344,  5792, 4344,    0,    0,  5792, 4344, 0,   0,   5792, 4344},// custom4
    ...
    case SENSOR_FEATURE_SEAMLESS_SWITCH:
        {
            ...
            switch (*feature_data) {
            case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
                TimeIMX = 3000/(imgsensor_info.custom5.pclk/imgsensor.frame_length/imgsensor_info.custom5.linelength);
                mdelay(TimeIMX);
                break;
            case MSDK_SCENARIO_ID_CUSTOM5:
                TimeIMX = 3000/(imgsensor_info.preview.pclk/imgsensor.frame_length/imgsensor_info.preview.linelength);
                mdelay(TimeIMX);
                break;
            }
