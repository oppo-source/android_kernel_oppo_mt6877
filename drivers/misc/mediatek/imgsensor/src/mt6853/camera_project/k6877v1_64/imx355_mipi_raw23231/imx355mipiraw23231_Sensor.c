...
#include "imx355mipiraw23231_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID23231,
...
static void read_module_data(void)
{
    ...
    gImgEepromInfo.i4CurSensorId = IMX355_SENSOR_ID22277;
            ...
            if (*sensor_id == IMX355_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if (deviceInfo_register_value == 0x00) {
                    Eeprom_DataInit(2, IMX355_SENSOR_ID23231);
