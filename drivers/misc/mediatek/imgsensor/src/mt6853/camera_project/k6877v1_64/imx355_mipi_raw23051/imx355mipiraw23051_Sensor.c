...
#include "imx355mipiraw23051_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID23051,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
    ...
    {3280, 2464,   488, 368, 2304, 1728, 2304, 1728,   0,   0, 2304, 1728, 0, 0, 2304, 1728},//custom1
    {3280, 2464,   824, 620, 1632, 1224, 1632, 1224,   0,   0, 1632, 1224, 0, 0, 1632, 1224},//custom2
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if (enable) {
        write_cmos_sensor_8(0x0601, 0x01);/*Solid Color*/
    } else {
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == IMX355_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("Imx355 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                if (deviceInfo_register_value == 0x00) {
                    Eeprom_DataInit(IMGSENSOR_SENSOR_IDX_MAIN2, IMX355_SENSOR_ID23051);
            ...
            pr_info("Imx355 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
        retry = 2;
