...
static kal_uint16 imx882_init_additional_setting[] = {
    //0908
    0x3B30, 0x01,
    0x3B32, 0x0A,
    0x3B33, 0x04,
...
static void sensor_init(void)
{
    ...
    if(imx882_hw_version != HW_CUT0_90) {
        imx882_table_write_cmos_sensor(imx882_init_additional_setting,
        sizeof(imx882_init_additional_setting)/sizeof(kal_uint16));
    }
