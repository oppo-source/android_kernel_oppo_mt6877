...
#include "imx615mipiraw23051_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX615_SENSOR_ID23051,
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == IMX615_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("Imx615 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                read_EepromQSC();
                if (deviceInfo_register_value == 0x00) {
                    Eeprom_DataInit(IMGSENSOR_SENSOR_IDX_SUB, IMX615_SENSOR_ID23051);
            ...
            pr_info("Imx615 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
        retry = 2;
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = -2097400;
        LOG_INF("exporsure");
    break;
