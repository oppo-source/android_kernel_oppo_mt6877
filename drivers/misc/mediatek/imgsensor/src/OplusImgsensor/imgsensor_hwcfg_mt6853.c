...
struct IMGSENSOR_SENSOR_LIST
    gimgsensor_sensor_list_lijinga[MAX_NUM_OF_SUPPORT_SENSOR] = {
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_lijinga[] = {
    {
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_lijinga[] = {
#if defined(S5K3L6_MIPI_RAW_LIJINGA)
    {
...
void oplus_imgsensor_hwcfg()
{
    ...
    } else if (is_project(23053) || is_project(23054)) {
         oplus_gimgsensor_sensor_list = gimgsensor_sensor_list_lijinga;
         oplus_imgsensor_custom_config = imgsensor_custom_config_lijinga;
         oplus_sensor_power_sequence = sensor_power_sequence_lijinga;
    ...
    } else if (is_project(22087) || is_project(22331) || is_project(22333) || is_project(22334)) {
         oplus_gimgsensor_sensor_list = gimgsensor_sensor_list_fanli;
