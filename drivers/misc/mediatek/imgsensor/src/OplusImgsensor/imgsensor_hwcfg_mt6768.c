...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_23618_ldo[] = {
    {
        IMGSENSOR_SENSOR_IDX_MAIN,
        IMGSENSOR_I2C_DEV_0,
        {
...
void oplus_imgsensor_hwcfg()
{
    ...
    if (is_project(21331) || is_project(21332) || is_project(21337)
        ...
        if (pcb_Version <= ARK_T0_PCB_VERSION) {
            oplus_imgsensor_custom_config = imgsensor_custom_config_23618;
        } else {
            oplus_imgsensor_custom_config = imgsensor_custom_config_23618_ldo;
        }
