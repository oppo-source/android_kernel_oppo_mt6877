...
/*mt6382 mipi hopping clk register*/
	...
	if (!strcmp(mtkfb_find_lcm_driver(),"ilt9881h_txd_hdp_dsi_vdo_lcm_drv")
      ...
      ||!strcmp(mtkfb_find_lcm_driver(),"oplus22351_tm_nt36672c_fhd_dsi_vdo_lcm_drv")
      ||!strcmp(mtkfb_find_lcm_driver(),"oplus22351_csot_ili7807s_fhd_dsi_vdo_lcm_drv")
      ||!strcmp(mtkfb_find_lcm_driver(),"oplus22361_boe_ili9883c_hd_dphy_vdo_lcm_drv")) {
		register_ccci_sys_call_back(MD_SYS1,
			MD_DISPLAY_DYNAMIC_MIPI, mipi_clk_change);
	}
#endif
