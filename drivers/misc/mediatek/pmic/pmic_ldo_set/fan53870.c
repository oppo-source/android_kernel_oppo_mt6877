...
int fan53870_cam_ldo_set_voltage(unsigned int LDO_NUM, int set_mv)
{
    ...
    switch(LDO_NUM){
        ...
        case 2:
            if (set_mv == 1100) {
                reg_value =0x89;    /*1.100V*/
            } else if (set_mv == 1050) {
                reg_value =0x83;    /*1.050V*/
            } else {
                reg_value =0x95;    /*1.200V*/
            }
               ...
               const struct i2c_device_id *id)
{
    ...
    /*if project is 21851 21876 135841,do not set fan53870 reset pin*/
    if (!(is_project(21851) || (is_project(21876)) || is_project(135841))) {
