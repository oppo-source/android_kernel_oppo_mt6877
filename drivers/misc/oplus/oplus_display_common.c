...
extern bool oplus_display_panel_cabc_support;
extern bool oplus_display_panel_cabc_power_saving_support;
...
int oplus_display_panel_set_cabc(void *buf)
{
	...
	if(oplus_display_panel_cabc_support) {
		printk("%s oplus_display_panel_cabc_support = %d\n", __func__, oplus_display_panel_cabc_support);

		/* oplus_display_panel_cabc_power_saving_support mean cabc 0--->3 or 3--->0,
		 * Solve the flickering problem caused by switching from 3 gears to 0 gear or 0 to 3 gears. */
		if (oplus_display_panel_cabc_power_saving_support) {
			printk("%s oplus_display_panel_cabc_power_saving_support = %d\n", __func__, oplus_display_panel_cabc_power_saving_support);
			if (cabc_true_mode == CABC_LEVEL_0 && cabc_mode_last == CABC_LEVEL_3) {
				usleep_range(3000, 4000);
				primary_display_set_cabc_mode(CABC_LEVEL_2);
				usleep_range(3000, 4000);
				primary_display_set_cabc_mode(CABC_LEVEL_1);
				usleep_range(3000, 4000);
			} else if (cabc_true_mode == CABC_LEVEL_3 && cabc_mode_last == CABC_LEVEL_0) {
				usleep_range(3000, 4000);
				primary_display_set_cabc_mode(CABC_LEVEL_1);
				usleep_range(3000, 4000);
				primary_display_set_cabc_mode(CABC_LEVEL_2);
